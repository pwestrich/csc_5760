...
void multiplyPthread(Matrix *const L, Matrix *const R, Matrix *const S, const int64_t numThreads){
...
void multiplyOMP(Matrix *const L, Matrix *const R, Matrix *const S, const int64_t numThreads){
